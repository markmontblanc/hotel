...
<section class="grid">
   ...
   <h1 class="heading">Адміністратори</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <p>Створити нового адміністратора</p>
      <a href="register.php" class="btn">Зареєструвати зараз</a>
   </div>
   ...
   <div class="box" <?php if( $fetch_admins['name'] == 'admin'){ echo 'style="display:none;"'; } ?>>
      <p>Логін: <span><?= $fetch_admins['name']; ?></span></p>
      <form action="" method="POST">
         <input type="hidden" name="delete_id" value="<?= $fetch_admins['id']; ?>">
         <input type="submit" value="Видалити адміністратора" onclick="return confirm('Ви впевнені що хочете видалити цього адміністратора?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
