...
if(isset($_POST['cancel'])){
   ...
   if($verify_booking->rowCount() > 0){
      ...
      $success_msg[] = 'Бронювання успішно скасовано!';
   }else{
      $warning_msg[] = 'Бронювання скасовано!';
   }
...
<section class="bookings">
   ...
   <h1 class="heading">Мої бронювання</h1>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="Скасувати бронювання" name="cancel" class="btn" onclick="return confirm('Ви впевнені, що бажаєте скасувати бронювання?');">
      </form>
   </div>
   <?php
    }
   ...
   <div class="box" style="text-align: center;">
      <p style="padding-bottom: .5rem; text-transform:capitalize;">Бронюваннь не знайдено!</p>
      <a href="index.php#reservation" class="btn">Здійснити нове бронювання</a>
   </div>
   <?php
   }
   ?>
